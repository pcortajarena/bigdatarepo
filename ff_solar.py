...
def load_data():
    ...
    if GOOGLE_COLAB:
      ...
      path = os.path.join('drive', 'My Drive', 'data', 'solar_energy_with_weather.csv')
    else:
...
if __name__ == '__main__':  
    ...
    model = dlc.fit_model(model, train_partial_x_values, train_partial_y_values, validation_x_values, validation_y_values, model_name='my_ff_solar.h5', epochs=EPOCHS, batch_size=1000)
